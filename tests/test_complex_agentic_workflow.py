...
def demonstrate_complex_agentic_workflow():
    ...
    example_path = (
        ...
        / "examples"
        / "old_examples"
        / "complex_agentic_workflow.py"
    )
    spec = spec_from_file_location("complex_agentic_workflow", example_path)
    module = module_from_spec(spec)
    sys.modules["complex_agentic_workflow"] = module
    spec.loader.exec_module(module)

    return module.demonstrate_complex_agentic_workflow()
